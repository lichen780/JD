...
[task_local]
#京喜财富岛合成珍珠互助
20 1 * * * https://raw.githubusercontent.com/KingRan/JDJB/main/jd_cfd_mooncake.js, tag=京喜财富岛合成珍珠互助, img-url=https://raw.githubusercontent.com/58xinian/icon/master/jxcfd.png, enabled=true

================Loon==============
[Script]
cron "20 1 * * *" script-path=https://raw.githubusercontent.com/KingRan/JDJB/main/jd_cfd_mooncake.js,tag=京喜财富岛合成珍珠互助

===============Surge=================
京喜财富岛合成珍珠互助 = type=cron,cronexp="20 1 * * *",wake-system=1,timeout=3600,script-path=https://raw.githubusercontent.com/KingRan/JDJB/main/jd_cfd_mooncake.js

============小火箭=========
京喜财富岛合成珍珠互助 = type=cron,script-path=https://raw.githubusercontent.com/KingRan/JDJB/main/jd_cfd_mooncake.js, cronexpr="20 1 * * *", timeout=3600, enable=true
 */
...
!(async () => {
  ...
  let res = await getAuthorShareCode('https://gitee.com/King2323Ran521/JD-Scripts/raw/master/shareCodes/cfd.json')
  $.strMyShareIds = [...(res || [])]
