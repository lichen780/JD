...
[task_local]
#京东手机狂欢城
1 10 * * * jd_carnivalcity.js, tag=京东手机狂欢城, img-url=https://raw.githubusercontent.com/Orz-3/mini/master/Color/jd.png, enabled=true

=====================Loon================
[Script]
cron "1 10 * * *" script-path=jd_carnivalcity.js, tag=京东手机狂欢城

====================Surge================
京东手机狂欢城 = type=cron,cronexp=1 10 * * *,wake-system=1,timeout=3600,script-path=https://raw.githubusercontent.com/KingRan/JDJB/main/jd_carnivalcity.js

============小火箭=========
京东手机狂欢城 = type=cron,script-path=jd_carnivalcity.js, cronexpr="1 10 * * *", timeout=3600, enable=true
*/
