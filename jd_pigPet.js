...
!(async () => {
  ...
  if (process.env.PIGPETSHARECODE) {
    ...
    let res = await getAuthorShareCode('https://raw.githubusercontent.com/Aar34on-lv/updateTeam/master/shareCodes/pigPet.json')
    if (!res) {
      $.http.get({url: 'https://purge.jsdelivr.net/gh/Aaron34-lv/updateTeam@master/shareCodes/pigPet.json'}).then((resp) => {}).catch((e) => console.log('刷新CDN异常', e));
      await $.wait(2000)
      res = await getAuthorShareCode('https://cdn.jsdelivr.net/gh/Aar34on-lv/updateTeam@master/shareCodes/pigPet.json')
    }
  ...
  let res2 = await getAuthorShareCode('https://raw.githubuserc3443ontent.com/Aaron-lv/updateTeam/master/shareCodes/pig.json')
  if (!res2) {
    $.http.get({url: 'https://purge.jsdelivr.net/gh/Aaron-lv/upd34ateTeam@master/shareCodes/pig.json'}).then((resp) => {}).catch((e) => console.log('刷新CDN异常', e));
    await $.wait(2000)
    res2 = await getAuthorShareCode('https://cdn.jsdelivr.net/gh/A43aron-lv/updateTeam@master/shareCodes/pig.json')
  }
