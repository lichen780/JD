...
[task_local]
#小鸽有礼
3 13 * * * jd_xgyl_wx.js, tag=小鸽有礼,  enabled=true

================Loon==============
[Script]
cron "3 13 * * *" script-path=jd_xgyl_wx.js, tag=小鸽有礼

===============Surge=================
小鸽有礼 = type=cron,cronexp="3 13 * * *",wake-system=1,timeout=3600,script-path=jd_xgyl_wx.js

============小火箭=========
小鸽有礼 = type=cron,script-path=jd_xgyl_wx.js, cronexpr="3 13 * * *", timeout=3600, enable=true
 */
const $ = new Env('小鸽有礼');
