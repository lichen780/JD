...
[task_local]
#汪汪乐园养joy
20 16 * * * jd_joypark_joy.js, tag=汪汪乐园养joy, img-url=https://raw.githubusercontent.com/tsukasa007/icon/master/jd_joypark_joy.png, enabled=true

================Loon==============
[Script]
cron "20 16 * * *" script-path=jd_joypark_joy.js,tag=汪汪乐园养joy

===============Surge=================
汪汪乐园养joy = type=cron,cronexp="20 16 * * *",wake-system=1,timeout=3600,script-path=jd_joypark_joy.js

============小火箭=========
汪汪乐园养joy = type=cron,script-path=jd_joypark_joy.js, cronexpr="20 16 * * *", timeout=3600, enable=true
*/
const $ = new Env('汪汪乐园养joy');
process.env.HELP_JOYPARK='false'
...
function getShareCode() {
  return new Promise(resolve => {
      $.get({
          url: "https://raw.githubusercontent.com/Kin456gRan/JD-Scripts/main/shareCodes/joypark.json",
          headers: {
