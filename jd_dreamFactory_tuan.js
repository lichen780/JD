...
[task_local]
#京喜工厂开团
40 10 * * * jd_dreamFactory.js, tag=京喜工厂开团, img-url=https://github.com/58xinian/icon/raw/master/jdgc.png, enabled=true

================Loon==============
[Script]
cron "40 10 * * *" script-path=jd_dreamFactory.js,tag=京喜工厂开团

===============Surge=================
京喜工厂开团 = type=cron,cronexp="40 10 * * *",wake-system=1,timeout=3600,script-path=jd_dreamFactory.js

============小火箭=========
京喜工厂开团 = type=cron,script-path=jd_dreamFactory.js, cronexpr="40 10 * * *", timeout=3600, enable=true
