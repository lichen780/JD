...
[task_local]
#京喜牧场
20 11 * * * https://raw.githubusercontent.com/KingRan/JDJB/main/jd_jxmc.js, tag=京喜牧场, img-url=https://github.com/58xinian/icon/raw/master/jdgc.png, enabled=true

================Loon==============
[Script]
cron "20 11 * * *" script-path=https://raw.githubusercontent.com/KingRan/JDJB/main/jd_jxmc.js,tag=京喜牧场

===============Surge=================
京喜牧场 = type=cron,cronexp="20 11 * * *",wake-system=1,timeout=3600,script-path=https://raw.githubusercontent.com/KingRan/JDJB/main/jd_jxmc.js

============小火箭=========
京喜牧场 = type=cron,script-path=https://raw.githubusercontent.com/KingRan/JDJB/main/jd_jxmc.js, cronexpr="20 11 * * *", timeout=3600, enable=true
 */
...
!(async () => {
  ...
  $.res = await getAuthorShareCode('https://cdn.jsdelivr.net/gh/KingRan/shareCodes@master/jxmc1.json')
