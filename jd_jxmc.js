/**
 惊喜牧场
 cron 23 0-23/10 * * * https://raw.githubusercontent.com/star261/jd/main/scripts/jd_jxmc.js
...
!(async () => {
    ...
    if(new Date().getHours() !== 10 && new Date().getHours() !== 17){
        console.log('\n脚本早上10点到17点直接执行，才会执行账号内互助');
        return ;
    }
    console.log('\n##################开始账号内互助#################\n');
