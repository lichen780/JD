...
[task_local]
#京喜财富岛互助
18 12 * * * https://raw.githubusercontent.com/KingRan/JDJB/main/jd_cfd_help.js, tag=京喜财富岛互助, img-url=https://raw.githubusercontent.com/58xinian/icon/master/jxcfd.png, enabled=true

================Loon==============
[Script]
cron "18 12 * * *" script-path=https://raw.githubusercontent.com/KingRan/JDJB/main/jd_cfd_help.js,tag=京喜财富岛互助

===============Surge=================
京喜财富岛互助 = type=cron,cronexp="18 12 * * *",wake-system=1,timeout=3600,script-path=https://raw.githubusercontent.com/KingRan/JDJB/main/jd_cfd_help.js

============小火箭=========
京喜财富岛互助 = type=cron,script-path=https://raw.githubusercontent.com/KingRan/JDJB/main/jd_cfd_help.js, cronexpr="18 12 * * *", timeout=3600, enable=true
...
!(async () => {
  ...
  let res = await getAuthorShareCode('https://gitee.com/KingRan3223521/JD-Scripts/raw/master/shareCodes/cfd.json')
  $.strMyShareIds = [...(res || [])]
