...
[task_local]
#京喜财富岛互助
20 0,11 * * * https://raw.githubusercontent.com/KingRan/KR/main/jd_cfd_help.js, tag=京喜财富岛互助, img-url=https://raw.githubusercontent.com/58xinian/icon/master/jxcfd.png, enabled=true

================Loon==============
[Script]
cron "20 0,11 * * *" script-path=https://raw.githubusercontent.com/KingRan/KR/main/jd_cfd_help.js,tag=京喜财富岛互助

===============Surge=================
京喜财富岛互助 = type=cron,cronexp="20 0,11 * * *",wake-system=1,timeout=3600,script-path=https://raw.githubusercontent.com/KingRan/KR/main/jd_cfd_help.js

============小火箭=========
京喜财富岛互助 = type=cron,script-path=https://raw.githubusercontent.com/KingRan/KR/main/jd_cfd_help.js, cronexpr="20 0,11 * * *", timeout=3600, enable=true
...
!(async () => {
  ...
  let res = await getAuthorShareCode('https://cdn.jsdelivr.net/gh/KingRan/shareCodes@master/c1fd.json')
  $.strMyShareIds = [...(res || [])]
