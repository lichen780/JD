...
[task_local]
京东金融天天拼图
20 10 * * * jd_ttpt.js, tag=京东金融天天拼图, enabled=true

================Loon==============
[Script]
cron "20 10 * * *" script-path=jd_ttpt.js,tag=京东金融天天拼图

===============Surge=================
京东金融天天拼图 = type=cron,cronexp="20 10 * * *",wake-system=1,timeout=20,script-path=jd_ttpt.js

============小火箭============
京东金融天天拼图 = type=cron,script-path=jd_ttpt.js, cronexpr="20 10 * * *", timeout=3600, enable=true
*
*/
const $ = new Env('天天拼图');
