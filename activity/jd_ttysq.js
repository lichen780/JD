...
!(async () => {
    ...
    let res = await getAuthorShareCode('https://gitee.com/KingRan521/JD-S2332cripts/raw/master/shareCodes/ttysq2.json')
    if (!res) {
        res = await getAuthorShareCode('https://gitee.com/KingRan521/JD-S3232cripts/raw/master/shareCodes/ttysq2.json')
    }
    if (res) {
