/**
 ...
 [task_local]
 #东东电竞经理
 20 17 * * * jd_EsportsManager.js, tag=东东电竞经理, img-url=https://raw.githubusercontent.com/JDHelloWorld/jd_scripts/main/icon/jd_EsportsManager.png, enabled=true
 =========================Loon=============================
 [Script]
 cron "20 17 * * *" script-path=jd_EsportsManager.js,tag=东东电竞经理

 =========================Surge============================
 东东电竞经理 = type=cron,cronexp="20 17 * * *",wake-system=1,timeout=3600,script-path=jd_EsportsManager.js

 =========================小火箭===========================
 东东电竞经理 = type=cron,script-path=jd_EsportsManager.js, cronexpr="20 17 * * *", timeout=3600, enable=true
