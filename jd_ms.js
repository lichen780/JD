...
[task_local]
#搞鸡玩家-秒秒币
30 12 * * * jd_ms.js, tag=搞鸡玩家-秒秒币, img-url=, enabled=true

================Loon==============
[Script]
cron "30 12 * * *" script-path=jd_ms.js, tag=搞鸡玩家-秒秒币

===============Surge=================
搞鸡玩家-秒秒币 = type=cron,cronexp="30 12 * * *",wake-system=1,timeout=3600,script-path=jd_ms.js

============小火箭=========
搞鸡玩家-秒秒币 = type=cron,script-path=jd_ms.js, cronexpr="30 12 * * *", timeout=3600, enable=true
 */
