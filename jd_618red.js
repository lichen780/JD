...
*/
process.env.gua_nhjRed_rebateCode='JM9vKg8'
//process.env.gua_nhjRed_rebatePin='243916681-111470'
let rebateCodes = ''
let rebatePin = ''
const $ = new Env('年货节红包');
  ...
  return new Promise(async resolve => {
    ...
    let opts = {
      ...
      headers: {
        ...
        "User-Agent": $.UA ,
		"Referer": "https://prodev.m.jd.com/mall/active/31e6keDr2FdaUEVSvNZM2kjD7QVx/index.html?unionActId=31142&d="+rebateCodes+"JKkMvJH&s=&cu=true&utm_source=kong&utm_medium=jingfen&utm_campaign=t_2014915613_&utm_term=6e7aef76891547adbc2a8a067de8f2aa",
      }
    }
