...
[task_local]
#京喜财富岛合成珍珠
5 3,12 * * * https://raw.githubusercontent.com/KingRan/JDJB/main/jd_cfd_mooncake.js, tag=京喜财富岛合成珍珠, img-url=https://raw.githubusercontent.com/58xinian/icon/master/jxcfd.png, enabled=true

================Loon==============
[Script]
cron "5 3,12 * * *" script-path=https://raw.githubusercontent.com/KingRan/JDJB/main/jd_cfd_mooncake.js,tag=京喜财富岛合成珍珠

===============Surge=================
京喜财富岛合成珍珠 = type=cron,cronexp="5 3,12 * * *",wake-system=1,timeout=3600,script-path=https://raw.githubusercontent.com/KingRan/JDJB/main/jd_cfd_mooncake.js

============小火箭=========
京喜财富岛合成珍珠 = type=cron,script-path=https://raw.githubusercontent.com/KingRan/JDJB/main/jd_cfd_mooncake.js, cronexpr="5 3,12 * * *", timeout=3600, enable=true
 */
...
!(async () => {
  ...
  let res = await getAuthorShareCode('https://gitee.com/KingR2322an521/JD-Scripts/raw/master/shareCodes/cfd.json')
  $.strMyShareIds = [...(res || [])]
