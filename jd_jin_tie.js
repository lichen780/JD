...
[task_local]
#领金贴
10 6 * * * jd_jin_tie.js, tag=领金贴, img-url=https://raw.githubusercontent.com/Orz-3/mini/master/Color/jd.png, enabled=true
===========Loon===============
[Script]
cron "10 6 * * *" script-path=https://raw.githubusercontent.com/KingRan/JDJB/main/jd_jin_tie.js,tag=领金贴
=======Surge===========
领金贴 = type=cron,cronexp="10 6 * * *",wake-system=1,timeout=3600,script-path=https://raw.githubusercontent.com/KingRan/JDJB/main/jd_jin_tie.js
==============小火箭=============
领金贴 = type=cron,script-path=https://raw.githubusercontent.com/KingRan/JDJB/main/jd_jin_tie.js, cronexpr="10 6 * * *", timeout=3600, enable=true
 */
const $ = new Env('领金贴');
