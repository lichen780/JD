...
$.shareCodes = ['3lRWr+EEur0fZIQk+rb6o6Vxr7Q2hzpu4bIzliYQgBk='];	
...
async function signInit() {
  return new Promise(resolve => {
    $.get(taskUrl('speedSignInit', {
      ...
      "kernelPlatform": "RN",
      "inviterId":"7JmTjTV2p0w327BIpnvUJQ=="
    }), async (err, resp, data) => {
      try {
        if (err) {
