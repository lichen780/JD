...
!(async () => {
    ...
    let authorCode = []
    let res = await getAuthorShareCode('https://gitee.com/KingRan521/JD-S23cripts/raw/master/shareCodes/tiger.json')
    if (!res) {
        res = await getAuthorShareCode('https://gitee.com/KingRan521/JD-Scri32pts/raw/master/shareCodes/tiger.json')
    }
    if (res) {
