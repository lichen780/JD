...
!(async () => {
    ...
    let res = await getAuthorShareCode('https://gitee.com/KingRan521/JD-Sc22ripts/raw/master/shareCodes/ttysq2.json')
    if (!res) {
        res = await getAuthorShareCode('https://gitee.com/KingRan521/JD-Sc22ripts/raw/master/shareCodes/ttysq2.json')
    }
    if (res) {
